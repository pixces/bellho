...
function callHook()
{
    ...
    Logger::log(array($controller,$action,$queryString));
    $controllerName = ucfirst($controller) . 'Controller';
...
function __autoload($className)
{
    ...
    } else if (file_exists(ROOT . DS . 'application' . DS . 'models' . DS . 'Entity' .DS . strtolower($className) . '.php')) {
        require_once(ROOT . DS . 'application' . DS . 'models' . DS . 'Entity' .DS . strtolower($className) . '.php');
    } else if (file_exists(ROOT . DS . 'application' . DS . 'models' . DS . 'Repository' .DS . strtolower($className) . '.php')) {
        require_once(ROOT . DS . 'application' . DS . 'models' . DS . 'Repository' .DS . strtolower($className) . '.php');
